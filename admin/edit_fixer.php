...
$query  = "select * from fixer where fixer_id = {$_GET['fixer_id']}";
...
if (isset($_POST["submit"])) {
    ...
    $fixer_password = $_POST["fixer_password"];
	 ...
	 $query = "update fixer set fixer_name='$fixer_name',fixer_phone='$fixer_phone',fixer_email='$fixer_email',fixer_address='$fixer_address',fixer_address='$fixer_address'
        where fixer_id = {$_GET['fixer_id']}";
							...
							<form action="" method="post" novalidate="novalidate">
								<div class="form-group">
									...
									<input id="cc-number" name="fixer_name" type="text" class="form-control cc-number identified visa"  data-val="true"
									 value="<?php echo $fixerSet["fixer_name"];?>"
                                ...
                                <div class="form-group">
                                  ...
                                  value="<?php echo $fixerSet["fixer_address"];?>"
								...
								<div class="form-group has-success">
									...
									<input id="cc-name" name="fixer_password" type="text" 
									value="<?php echo $fixerSet["fixer_password"];?>"
