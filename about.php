    ...
    <div class="wrapper">
     ...
     <!-- Header Section End -->
        ...
        <div class="page-header--section text-center">
            <!-- Page Title Start -->
            <div class="page--title pd--130-0" data-bg-img="img/mobifix_background/mobifix-12.png">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="about--content col-sm-6 pb--60">
                        <h2 class="h2">Welcome to <span>MobiFix</span></h2>

                        <p>Mobifix be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many , and a search for 'lorem ipsum' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose.</p>

                        <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum.</p>

                        <ul>
                            <li><i class="fa fm fa-angle-double-right"></i>Aliquam tincidunt mauris eu risus</li>
                            <li><i class="fa fm fa-angle-double-right"></i>Integer vitae libero ac risus egestas placerat</li>
                            <li><i class="fa fm fa-angle-double-right"></i>Cras iaculis ultricies nulla</li>
                        </ul>
                    </div>
                    <!-- About Content End -->
                    ...
                    <div class="about--gallery col-sm-6 pb--60">
                        <div class="about--gallery-video bg--overlay">
                            <img src="img/mobifix_background/mobifix-11.png" alt="" data-rjs="2">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-6 col-xs-6">
                                <a href="img/mobifix_background/mobifix-5.png" class="about--gallery-img bg--overlay" data-popup="img">
                                    <img src="img/mobifix_background/mobifix-5.png" alt="" data-rjs="2">
                                </a>
                            </div>

                            <div class="col-md-4 col-sm-6 col-xs-6">
                                <a href="img/mobifix_background/mobifix-6.jpg" class="about--gallery-img bg--overlay" data-popup="img">
                                    <img src="img/mobifix_background/mobifix-6.jpg" alt="" data-rjs="2">
                                </a>
                            </div>

                            <div class="col-md-4 hidden-sm hidden-xs">
                                <a href="img/mobifix_background/mobifix-7.png" class="about--gallery-img bg--overlay" data-popup="img">
                                    <img src="img/mobifix_background/mobifix-7.png" alt="" data-rjs="2">
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="footer--about">
                            ...
                            <div class="info">
                                <ul class="nav">
                                    ...
                                    <li class="fa-phone-square"><a href="mailto:+962788344472">+962788344472</a> </li>
